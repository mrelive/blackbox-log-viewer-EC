import { FlightLogSticks } from "./sticks.js";
...
import { Craft2D } from "./craft_2d.js";
import { Craft3D } from "./craft_3d.js";
import { FlightLogAnalyser } from "./graph_spectrum.js";
import { LapTimer } from "./laptimer.js";
import { GraphConfig } from "./graph_config.js";
import { ExpoCurve } from "./expo.js";
import { leftPad, formatTime } from "./tools.js";
    ...
    for (i = 0; i < graphs.length; i++) {
      ...
      for (let j = 0; j < graphs[i].fields.length; j++) {
        ...
        if (field.smoothing > 0) {
          smoothing[field.index] = options.graphSmoothOverride
            ? 0
            : field.smoothing;
        }
      }
